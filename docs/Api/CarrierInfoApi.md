...
> \OpenAPI\Client\Model\CarrierFacilityResponse v1CarrierFacilityPost($carrier_facility_request, $x_pb_unified_error_structure)
...
try {
    $result = $apiInstance->v1CarrierFacilityPost($carrier_facility_request, $x_pb_unified_error_structure);
    print_r($result);
} catch (Exception $e) {
    echo 'Exception when calling CarrierInfoApi->v1CarrierFacilityPost: ', $e->getMessage(), PHP_EOL;
}
?>
```
...
------------- | ------------- | ------------- | -------------
 **carrier_facility_request** | [**\OpenAPI\Client\Model\CarrierFacilityRequest**](../Model/CarrierFacilityRequest.md)|  |
...
[**\OpenAPI\Client\Model\CarrierFacilityResponse**](../Model/CarrierFacilityResponse.md)
...
> \OpenAPI\Client\Model\InlineResponse200 v1CarrierLicenseAgreementsGet($accept_language, $carrier, $origin_country_code, $x_pb_unified_error_structure)
...
$origin_country_code = US; // \OpenAPI\Client\Model\ISOCountryCode | The two-character ISO country code for the country where the shipment originates.
$x_pb_unified_error_structure = true; // string | Set this to true to use the standard [error object](https://shipping.pitneybowes.com/reference/error-object.html#standard-error-object) if an error occurs.

try {
    $result = $apiInstance->v1CarrierLicenseAgreementsGet($accept_language, $carrier, $origin_country_code, $x_pb_unified_error_structure);
    print_r($result);
} catch (Exception $e) {
    echo 'Exception when calling CarrierInfoApi->v1CarrierLicenseAgreementsGet: ', $e->getMessage(), PHP_EOL;
}
?>
```
 ...
 **origin_country_code** | [**\OpenAPI\Client\Model\ISOCountryCode**](../Model/.md)| The two-character ISO country code for the country where the shipment originates. |
 **x_pb_unified_error_structure** | **string**| Set this to true to use the standard [error object](https://shipping.pitneybowes.com/reference/error-object.html#standard-error-object) if an error occurs. | [optional] [default to &#39;true&#39;]
...
> object[] v1CountriesGet($accept_language, $carrier, $origin_country_code, $x_pb_unified_error_structure)
...
$accept_language = en-US; // string | This HTTP header advertises which languages the client is able to understand, and which locale variant is preferred.
$carrier = usps; // \OpenAPI\Client\Model\Carrier | The carrier name. Currently this must be set to: USPS
$origin_country_code = US; // \OpenAPI\Client\Model\ISOCountryCode | The two-character ISO country code for the country where the shipment originates.
$x_pb_unified_error_structure = true; // string | Set this to true to use the standard [error object](https://shipping.pitneybowes.com/reference/error-object.html#standard-error-object) if an error occurs.

try {
    $result = $apiInstance->v1CountriesGet($accept_language, $carrier, $origin_country_code, $x_pb_unified_error_structure);
    print_r($result);
} catch (Exception $e) {
    echo 'Exception when calling CarrierInfoApi->v1CountriesGet: ', $e->getMessage(), PHP_EOL;
}
?>
```
...
------------- | ------------- | ------------- | -------------
 **accept_language** | **string**| This HTTP header advertises which languages the client is able to understand, and which locale variant is preferred. | [default to &#39;en-US&#39;]
 **carrier** | [**\OpenAPI\Client\Model\Carrier**](../Model/.md)| The carrier name. Currently this must be set to: USPS |
 **origin_country_code** | [**\OpenAPI\Client\Model\ISOCountryCode**](../Model/.md)| The two-character ISO country code for the country where the shipment originates. |
 **x_pb_unified_error_structure** | **string**| Set this to true to use the standard [error object](https://shipping.pitneybowes.com/reference/error-object.html#standard-error-object) if an error occurs. | [optional] [default to &#39;true&#39;]
...
> \OpenAPI\Client\Model\CarrierRule v1InformationRulesRatingServicesGet($accept_language, $carrier, $origin_country_code, $destination_country_code, $x_pb_unified_error_structure, $rate_type_id, $future_shipment_date, $return_shipment, $compact_response)
...
$accept_language = en-US; // string | This HTTP header advertises which languages the client is able to understand, and which locale variant is preferred.
$carrier = USPS; // \OpenAPI\Client\Model\Carrier | The carrier name. **Currently this must be set to: USPS**
$origin_country_code = US; // \OpenAPI\Client\Model\ISOCountryCode | The [two-character ISO country code](https://www.iso.org/obp/ui/#search) for the country where the shipment originates.
$destination_country_code = IN; // \OpenAPI\Client\Model\ISOCountryCode | The [two-character ISO country code](https://www.iso.org/obp/ui/#search) for the country of the shipment's destination address.
$x_pb_unified_error_structure = true; // string | Set this to true to use the standard [error object](https://shipping.pitneybowes.com/reference/error-object.html#standard-error-object) if an error occurs.
...
try {
    $result = $apiInstance->v1InformationRulesRatingServicesGet($accept_language, $carrier, $origin_country_code, $destination_country_code, $x_pb_unified_error_structure, $rate_type_id, $future_shipment_date, $return_shipment, $compact_response);
    print_r($result);
} catch (Exception $e) {
    echo 'Exception when calling CarrierInfoApi->v1InformationRulesRatingServicesGet: ', $e->getMessage(), PHP_EOL;
}
?>
```
 ...
 **accept_language** | **string**| This HTTP header advertises which languages the client is able to understand, and which locale variant is preferred. | [default to &#39;en-US&#39;]
 **carrier** | [**\OpenAPI\Client\Model\Carrier**](../Model/.md)| The carrier name. **Currently this must be set to: USPS** |
 **origin_country_code** | [**\OpenAPI\Client\Model\ISOCountryCode**](../Model/.md)| The [two-character ISO country code](https://www.iso.org/obp/ui/#search) for the country where the shipment originates. |
 **destination_country_code** | [**\OpenAPI\Client\Model\ISOCountryCode**](../Model/.md)| The [two-character ISO country code](https://www.iso.org/obp/ui/#search) for the country of the shipment&#39;s destination address. |
 **x_pb_unified_error_structure** | **string**| Set this to true to use the standard [error object](https://shipping.pitneybowes.com/reference/error-object.html#standard-error-object) if an error occurs. | [optional] [default to &#39;true&#39;]
...
[**\OpenAPI\Client\Model\CarrierRule**](../Model/CarrierRule.md)
