...
class ParcelProtectionApi
{
     ...
     * @return \OpenAPI\Client\Model\ParcelProtectionPolicyResponse|\OpenAPI\Client\Model\Errors
     */
     ...
     * @throws \OpenAPI\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \OpenAPI\Client\Model\ParcelProtectionPolicyResponse|\OpenAPI\Client\Model\Errors, HTTP status code, HTTP response headers (array of strings)
     */
    public function getParcelProtectionReportsWithHttpInfo($x_pb_transaction_id, $developer_id, $policy_created_from_date, $x_pb_unified_error_structure = 'true', $policy_created_to_date = null, $policy_reference_id = null, $parcel_tracking_number = null, $merchant_id = null, $policy_status = null, $size = null, $page = null, $sort = null)
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\OpenAPI\Client\Model\ParcelProtectionPolicyResponse' === '\SplFileObject') {
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\OpenAPI\Client\Model\ParcelProtectionPolicyResponse', []),
            ...
            $returnType = '\OpenAPI\Client\Model\ParcelProtectionPolicyResponse';
            $responseBody = $response->getBody();
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\OpenAPI\Client\Model\ParcelProtectionPolicyResponse',
    ...
    /**
     * Operation parcelProtectionCoverage
     *
     * Parcel Protection Coverage
     *
     * @param  string $x_pb_transaction_id Required. A unique identifier for the transaction, up to 25 characters. (required)
     * @param  \OpenAPI\Client\Model\ParcelProtectionCreateRequest $parcel_protection_create_request manifest (required)
     * @param  string $x_pb_unified_error_structure Set this to true to use the standard [error object](https://shipping.pitneybowes.com/reference/error-object.html#standard-error-object) if an error occurs. (optional, default to 'true')
     *
     * @throws \OpenAPI\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \OpenAPI\Client\Model\ParcelProtectionCreateResponse|\OpenAPI\Client\Model\Errors
     */
    public function parcelProtectionCoverage($x_pb_transaction_id, $parcel_protection_create_request, $x_pb_unified_error_structure = 'true')
    {
        list($response) = $this->parcelProtectionCoverageWithHttpInfo($x_pb_transaction_id, $parcel_protection_create_request, $x_pb_unified_error_structure);
        return $response;
    }

    /**
     * Operation parcelProtectionCoverageWithHttpInfo
     *
     * Parcel Protection Coverage
     *
     * @param  string $x_pb_transaction_id Required. A unique identifier for the transaction, up to 25 characters. (required)
     ...
     * @throws \OpenAPI\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \OpenAPI\Client\Model\ParcelProtectionCreateResponse|\OpenAPI\Client\Model\Errors, HTTP status code, HTTP response headers (array of strings)
     */
    public function parcelProtectionCoverageWithHttpInfo($x_pb_transaction_id, $parcel_protection_create_request, $x_pb_unified_error_structure = 'true')
    {
        $request = $this->parcelProtectionCoverageRequest($x_pb_transaction_id, $parcel_protection_create_request, $x_pb_unified_error_structure);
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\OpenAPI\Client\Model\ParcelProtectionCreateResponse' === '\SplFileObject') {
                        $content = $responseBody; //stream goes to serializer
                    } else {
                        $content = (string) $responseBody;
                    }
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\OpenAPI\Client\Model\ParcelProtectionCreateResponse', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
                default:
            ...
            $returnType = '\OpenAPI\Client\Model\ParcelProtectionCreateResponse';
            $responseBody = $response->getBody();
            if ($returnType === '\SplFileObject') {
                $content = $responseBody; //stream goes to serializer
            } else {
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\OpenAPI\Client\Model\ParcelProtectionCreateResponse',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
    ...
    /**
     * Operation parcelProtectionCoverageAsync
     *
     * Parcel Protection Coverage
     *
     * @param  string $x_pb_transaction_id Required. A unique identifier for the transaction, up to 25 characters. (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function parcelProtectionCoverageAsync($x_pb_transaction_id, $parcel_protection_create_request, $x_pb_unified_error_structure = 'true')
    {
        return $this->parcelProtectionCoverageAsyncWithHttpInfo($x_pb_transaction_id, $parcel_protection_create_request, $x_pb_unified_error_structure)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation parcelProtectionCoverageAsyncWithHttpInfo
     *
     * Parcel Protection Coverage
     *
     * @param  string $x_pb_transaction_id Required. A unique identifier for the transaction, up to 25 characters. (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function parcelProtectionCoverageAsyncWithHttpInfo($x_pb_transaction_id, $parcel_protection_create_request, $x_pb_unified_error_structure = 'true')
    {
        $returnType = '\OpenAPI\Client\Model\ParcelProtectionCreateResponse';
        $request = $this->parcelProtectionCoverageRequest($x_pb_transaction_id, $parcel_protection_create_request, $x_pb_unified_error_structure);
    ...
    /**
     * Create request for operation 'parcelProtectionCoverage'
     *
     * @param  string $x_pb_transaction_id Required. A unique identifier for the transaction, up to 25 characters. (required)
     * @param  \OpenAPI\Client\Model\ParcelProtectionCreateRequest $parcel_protection_create_request manifest (required)
     * @param  string $x_pb_unified_error_structure Set this to true to use the standard [error object](https://shipping.pitneybowes.com/reference/error-object.html#standard-error-object) if an error occurs. (optional, default to 'true')
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function parcelProtectionCoverageRequest($x_pb_transaction_id, $parcel_protection_create_request, $x_pb_unified_error_structure = 'true')
    {
        // verify the required parameter 'x_pb_transaction_id' is set
        if ($x_pb_transaction_id === null || (is_array($x_pb_transaction_id) && count($x_pb_transaction_id) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $x_pb_transaction_id when calling parcelProtectionCoverage'
            );
        }
        ...
        if ($parcel_protection_create_request === null || (is_array($parcel_protection_create_request) && count($parcel_protection_create_request) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $parcel_protection_create_request when calling parcelProtectionCoverage'
            );
        }
    ...
    /**
     * Operation parcelProtectionQuote
     *
     * Parcel Protection Quote
     *
     * @param  string $x_pb_transaction_id Required. A unique identifier for the transaction, up to 25 characters. (required)
     * @param  \OpenAPI\Client\Model\ParcelProtectionQuoteRequest $parcel_protection_quote_request manifest (required)
     * @param  string $x_pb_unified_error_structure Set this to true to use the standard [error object](https://shipping.pitneybowes.com/reference/error-object.html#standard-error-object) if an error occurs. (optional, default to 'true')
     *
     * @throws \OpenAPI\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \OpenAPI\Client\Model\ParcelProtectionQuoteResponse|\OpenAPI\Client\Model\Errors
     */
    public function parcelProtectionQuote($x_pb_transaction_id, $parcel_protection_quote_request, $x_pb_unified_error_structure = 'true')
    {
        list($response) = $this->parcelProtectionQuoteWithHttpInfo($x_pb_transaction_id, $parcel_protection_quote_request, $x_pb_unified_error_structure);
        return $response;
    }

    /**
     * Operation parcelProtectionQuoteWithHttpInfo
     *
     * Parcel Protection Quote
     *
     * @param  string $x_pb_transaction_id Required. A unique identifier for the transaction, up to 25 characters. (required)
     ...
     * @throws \OpenAPI\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \OpenAPI\Client\Model\ParcelProtectionQuoteResponse|\OpenAPI\Client\Model\Errors, HTTP status code, HTTP response headers (array of strings)
     */
    public function parcelProtectionQuoteWithHttpInfo($x_pb_transaction_id, $parcel_protection_quote_request, $x_pb_unified_error_structure = 'true')
    {
        $request = $this->parcelProtectionQuoteRequest($x_pb_transaction_id, $parcel_protection_quote_request, $x_pb_unified_error_structure);
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\OpenAPI\Client\Model\ParcelProtectionQuoteResponse' === '\SplFileObject') {
                        $content = $responseBody; //stream goes to serializer
                    } else {
                        $content = (string) $responseBody;
                    }
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\OpenAPI\Client\Model\ParcelProtectionQuoteResponse', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
                default:
            ...
            $returnType = '\OpenAPI\Client\Model\ParcelProtectionQuoteResponse';
            $responseBody = $response->getBody();
            if ($returnType === '\SplFileObject') {
                $content = $responseBody; //stream goes to serializer
            } else {
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\OpenAPI\Client\Model\ParcelProtectionQuoteResponse',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
    ...
    /**
     * Operation parcelProtectionQuoteAsync
     *
     * Parcel Protection Quote
     *
     * @param  string $x_pb_transaction_id Required. A unique identifier for the transaction, up to 25 characters. (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function parcelProtectionQuoteAsync($x_pb_transaction_id, $parcel_protection_quote_request, $x_pb_unified_error_structure = 'true')
    {
        return $this->parcelProtectionQuoteAsyncWithHttpInfo($x_pb_transaction_id, $parcel_protection_quote_request, $x_pb_unified_error_structure)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation parcelProtectionQuoteAsyncWithHttpInfo
     *
     * Parcel Protection Quote
     *
     * @param  string $x_pb_transaction_id Required. A unique identifier for the transaction, up to 25 characters. (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function parcelProtectionQuoteAsyncWithHttpInfo($x_pb_transaction_id, $parcel_protection_quote_request, $x_pb_unified_error_structure = 'true')
    {
        $returnType = '\OpenAPI\Client\Model\ParcelProtectionQuoteResponse';
        $request = $this->parcelProtectionQuoteRequest($x_pb_transaction_id, $parcel_protection_quote_request, $x_pb_unified_error_structure);
    ...
    /**
     * Create request for operation 'parcelProtectionQuote'
     *
     * @param  string $x_pb_transaction_id Required. A unique identifier for the transaction, up to 25 characters. (required)
     * @param  \OpenAPI\Client\Model\ParcelProtectionQuoteRequest $parcel_protection_quote_request manifest (required)
     * @param  string $x_pb_unified_error_structure Set this to true to use the standard [error object](https://shipping.pitneybowes.com/reference/error-object.html#standard-error-object) if an error occurs. (optional, default to 'true')
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function parcelProtectionQuoteRequest($x_pb_transaction_id, $parcel_protection_quote_request, $x_pb_unified_error_structure = 'true')
    {
        // verify the required parameter 'x_pb_transaction_id' is set
        if ($x_pb_transaction_id === null || (is_array($x_pb_transaction_id) && count($x_pb_transaction_id) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $x_pb_transaction_id when calling parcelProtectionQuote'
            );
        }
        ...
        if ($parcel_protection_quote_request === null || (is_array($parcel_protection_quote_request) && count($parcel_protection_quote_request) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $parcel_protection_quote_request when calling parcelProtectionQuote'
            );
        }
    ...
    /**
     * Operation parcelProtectionVoid
     *
     * Parcel Protection Coverage
     *
     * @param  string $x_pb_transaction_id Required. A unique identifier for the transaction, up to 25 characters. (required)
     ...
     * @param  \OpenAPI\Client\Model\VoidParcelProtectionRequest $void_parcel_protection_request manifest (required)
     * @param  string $x_pb_unified_error_structure Set this to true to use the standard [error object](https://shipping.pitneybowes.com/reference/error-object.html#standard-error-object) if an error occurs. (optional, default to 'true')
     *
     * @throws \OpenAPI\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \OpenAPI\Client\Model\VoidParcelProtectionResponse|\OpenAPI\Client\Model\Errors
     */
    public function parcelProtectionVoid($x_pb_transaction_id, $parcel_protection_reference_id, $void_parcel_protection_request, $x_pb_unified_error_structure = 'true')
    {
        list($response) = $this->parcelProtectionVoidWithHttpInfo($x_pb_transaction_id, $parcel_protection_reference_id, $void_parcel_protection_request, $x_pb_unified_error_structure);
        return $response;
    }

    /**
     * Operation parcelProtectionVoidWithHttpInfo
     *
     * Parcel Protection Coverage
     *
     * @param  string $x_pb_transaction_id Required. A unique identifier for the transaction, up to 25 characters. (required)
     ...
     * @throws \OpenAPI\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \OpenAPI\Client\Model\VoidParcelProtectionResponse|\OpenAPI\Client\Model\Errors, HTTP status code, HTTP response headers (array of strings)
     */
    public function parcelProtectionVoidWithHttpInfo($x_pb_transaction_id, $parcel_protection_reference_id, $void_parcel_protection_request, $x_pb_unified_error_structure = 'true')
    {
        $request = $this->parcelProtectionVoidRequest($x_pb_transaction_id, $parcel_protection_reference_id, $void_parcel_protection_request, $x_pb_unified_error_structure);
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\OpenAPI\Client\Model\VoidParcelProtectionResponse' === '\SplFileObject') {
                        $content = $responseBody; //stream goes to serializer
                    } else {
                        $content = (string) $responseBody;
                    }
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\OpenAPI\Client\Model\VoidParcelProtectionResponse', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
                default:
            ...
            $returnType = '\OpenAPI\Client\Model\VoidParcelProtectionResponse';
            $responseBody = $response->getBody();
            if ($returnType === '\SplFileObject') {
                $content = $responseBody; //stream goes to serializer
            } else {
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\OpenAPI\Client\Model\VoidParcelProtectionResponse',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
    ...
    /**
     * Operation parcelProtectionVoidAsync
     *
     * Parcel Protection Coverage
     *
     * @param  string $x_pb_transaction_id Required. A unique identifier for the transaction, up to 25 characters. (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function parcelProtectionVoidAsync($x_pb_transaction_id, $parcel_protection_reference_id, $void_parcel_protection_request, $x_pb_unified_error_structure = 'true')
    {
        return $this->parcelProtectionVoidAsyncWithHttpInfo($x_pb_transaction_id, $parcel_protection_reference_id, $void_parcel_protection_request, $x_pb_unified_error_structure)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation parcelProtectionVoidAsyncWithHttpInfo
     *
     * Parcel Protection Coverage
     *
     * @param  string $x_pb_transaction_id Required. A unique identifier for the transaction, up to 25 characters. (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function parcelProtectionVoidAsyncWithHttpInfo($x_pb_transaction_id, $parcel_protection_reference_id, $void_parcel_protection_request, $x_pb_unified_error_structure = 'true')
    {
        $returnType = '\OpenAPI\Client\Model\VoidParcelProtectionResponse';
        $request = $this->parcelProtectionVoidRequest($x_pb_transaction_id, $parcel_protection_reference_id, $void_parcel_protection_request, $x_pb_unified_error_structure);
    ...
    /**
     * Create request for operation 'parcelProtectionVoid'
     *
     * @param  string $x_pb_transaction_id Required. A unique identifier for the transaction, up to 25 characters. (required)
     * @param  string $parcel_protection_reference_id Required. The identifier for the PB Parcel Protection policy that is being voided. (required)
     * @param  \OpenAPI\Client\Model\VoidParcelProtectionRequest $void_parcel_protection_request manifest (required)
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function parcelProtectionVoidRequest($x_pb_transaction_id, $parcel_protection_reference_id, $void_parcel_protection_request, $x_pb_unified_error_structure = 'true')
    {
        // verify the required parameter 'x_pb_transaction_id' is set
        if ($x_pb_transaction_id === null || (is_array($x_pb_transaction_id) && count($x_pb_transaction_id) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $x_pb_transaction_id when calling parcelProtectionVoid'
            );
        }
        ...
        if ($parcel_protection_reference_id === null || (is_array($parcel_protection_reference_id) && count($parcel_protection_reference_id) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $parcel_protection_reference_id when calling parcelProtectionVoid'
            );
        }
        ...
        if ($void_parcel_protection_request === null || (is_array($void_parcel_protection_request) && count($void_parcel_protection_request) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $void_parcel_protection_request when calling parcelProtectionVoid'
            );
        }
