...
class CustomsItem implements ModelInterface, ArrayAccess
{
    ...
    protected static $openAPITypes = [
        ...
        'producer_address' => '\OpenAPI\Client\Model\Address',
        'producer_determination' => 'string',
        'producer_id' => 'string',
        'quantity' => 'int',
        'quantity_uom' => 'string',
        'unit_price' => 'float',
        'unit_weight' => '\OpenAPI\Client\Model\ParcelWeight'
    ];
     ...
     *
     * @param \OpenAPI\Client\Model\Address|null $producer_address producer_address
     *
     * @return $this
     */
     ...
     * Gets unit_weight
     *
     * @return \OpenAPI\Client\Model\ParcelWeight
     */
     ...
     * Sets unit_weight
     *
     * @param \OpenAPI\Client\Model\ParcelWeight $unit_weight unit_weight
     *
     * @return $this
     */
